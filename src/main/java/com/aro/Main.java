...
import com.aro.service.impl.ExpandedCronWithCommandParserServiceImpl;

import java.util.Map;

public class Main {

    private final CronParserService cronParserService = new ExpandedCronWithCommandParserServiceImpl();
