...
public class CronWithCommandParserServiceImplTests {
    ...
    public void testParseField_success() throws WrongCronException {
        ...
        assertEquals("9 16 23 30 37 44 51 58", service.parseField("9/7", CronWithCommandFieldsEnum.MINUTE));
        ...
        assertEquals("2 7 12", service.parseField("2/5", CronWithCommandFieldsEnum.MONTH));
        assertEquals("1 6 11", service.parseField("*/5", CronWithCommandFieldsEnum.MONTH));
